...
export default class DeleteTestData extends LightningElement {
    ...
    handleClearTestData() {
      ...
      /*
           // let baseUrl = window.location.origin;
            let testURL = 'https://empathetic-goat-j2hay1-dev-ed.trailblaze.lightning.force.com/lightning/setup/ApexTestQueue/page?address=%2F07M'
    ...
    handleRunAllTestInNamespace() {
        // Call the Apex method to run tests and get the job ID
        runTestsInNamespace()
            .then(result => {
                this.jobId = result;
